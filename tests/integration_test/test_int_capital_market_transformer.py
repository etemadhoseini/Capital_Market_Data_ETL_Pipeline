"""Integration Test CapitalMarketETLMethods"""
import os
import unittest
...
from capital_market.common.constants import MetaProcessFormat
...
class IntTestCapitalMarketETLMethods(unittest.TestCase):
    """
    Integration testing the CapitalMarketETL class.
    """
    ...
    def setUp(self):
        ...
        self.s3_endpoint_url = 'https://s3.eu-north-1.amazonaws.com'
        self.s3_bucket_name_src = 'capital-market-int-test-src'
        self.s3_bucket_name_trg = 'capital-market-int-test-trg'
    ...
    def test_int_etl_report_no_metafile(self):
        """
        Integration test for the etl_report method
        """
        # Expected results
